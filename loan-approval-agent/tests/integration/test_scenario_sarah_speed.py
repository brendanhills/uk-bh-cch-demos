...
async def test_sarah_speed_auto_approve():
    ...
    with patch("external_services.simulation_utils.simulate_delay", return_value=None), \
        ...
        # It should have consulted the Investigator, Policy Expert, and Underwriter.
        # Note: If used as AgentTool, internal tools might not appear as top-level function calls.
        ...
        # 3. Data Integrity Assertion
        assert "City Hospital" in full_text or "City Hospital".upper() in full_text.upper()
        assert "15,000" in full_text or "$15000" in full_text
