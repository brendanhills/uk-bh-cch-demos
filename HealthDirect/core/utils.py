...
def parse_common_args(description: str, is_mono: bool = False):
    ...
    parser.add_argument("--model", default="telephony", help="STT model (telephony, chirp_3, medical_conversation) [Default: telephony]")
...
async def setup_pipeline(args, approach_name: str, force_mono: bool = False):
    ...
    if mode == "low_latency":
        # In low-latency mode, the engine should just pass events through.
