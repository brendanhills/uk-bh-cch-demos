...
from catalyst_front_door.agent import root_agent
from google.genai import types as genai_types
...
async def main():
    ...
    await session_service.create_session(
        app_name="catalyst_front_door", user_id="test_user", session_id="test_session"
    )
    runner = Runner(
        agent=root_agent, app_name="catalyst_front_door", session_service=session_service
    )
