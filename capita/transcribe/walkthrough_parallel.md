...
In the monolithic approach, the broadcaster just pipes bytes. In Parallel mode, the broadcaster takes on a "low-level" audio processing role:
...
## Comparison: Parallel vs. Monolithic

| Feature | Parallel | Monolithic |
| :--- | :--- | :--- |
