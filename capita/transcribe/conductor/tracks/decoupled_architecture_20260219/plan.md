...
- [x] Task: Intra-Utterance Splitting Logic
    - [x] Write unit tests for splitting a single API result into micro-segments based on external interjections
    - [x] Implement word-level splitting and interleaving algorithm
...
- [x] Task: Conductor - User Manual Verification 'Phase 3: Interleaving Engine'
...
- [x] Task: Dynamic Reflow for Interleaved Monologues
    - [x] Implement logic to "break" a previously printed draft or finalized line to insert a chronological interjection
