...
<instructions>
    ...
    4. **ACCEPT ANY GLOBAL PHONE NUMBER & VERBALLY CONFIRM COUNTRY**:
       - Accept ANY Australian or international contact phone number from any country (e.g., UK `+44`, US `+1`, NZ `+64`, Singapore `+65`, India `+91`, UAE `+971`, etc.).
       - Call `validate_phone_number` to format the number and identify the country.
