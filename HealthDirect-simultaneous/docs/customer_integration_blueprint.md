...
| :--- | :--- | :--- |
| **WebSocket Connection & Streaming (Section 6)** | [demo/web_server.py](file:///home/brendanhills/dev/uk-bh-experiments/HealthDirect-simultaneous/demo/web_server.py) | Establishes the real-time parallel client connection loops (using FastAPI WebSockets or with `--cli` terminal mode), manages concurrent audio-streaming, and receives transcripts. |
| **Recursive Glossary Schema Ingestion (Section 7)** | [import_glossary.py](file:///home/brendanhills/dev/uk-bh-experiments/HealthDirect-simultaneous/import_glossary.py) | Scrapes raw terminologies from the web, recursively unpacks complex list/dictionary formats, and caches them in `/glossary` for model priming. |
| **Chronological Interleaving & Stabilization (Section 8)** | [demo/web_server.py](file:///home/brendanhills/dev/uk-bh-experiments/HealthDirect-simultaneous/demo/web_server.py) | Houses the central playback-synchronization buffers and pacing state machines that align the English-speaking Nurse channel with the foreign-language Patient channel. |
| **Dual-Column Demo Frontend App** | [demo/web_server.py](file:///home/brendanhills/dev/uk-bh-experiments/HealthDirect-simultaneous/demo/web_server.py) | Integrates translation and UI elements into a responsive, local-facing FastAPI + HTML user interface. |
| **Sample Audio Generation & Throttling** | [generate_simultaneous_audio.py](file:///home/brendanhills/dev/uk-bh-experiments/HealthDirect-simultaneous/generate_simultaneous_audio.py) | Utilizes SSML and Google Text-to-Speech API to generate dual-channel conversations to simulate physical playheads. |
